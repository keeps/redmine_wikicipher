...
class WikiPage < ActiveRecord::Base
  ...
  def diff(version_to=nil, version_from=nil)
    ...
    logger.warn("BEFORE: "+content_to.text)
    content_to.text = decodeContentWithTags(content_to.text)
    content_from.text = decodeContentWithTags(content_from.text)
    logger.warn("AFTER: "+content_to.text)
